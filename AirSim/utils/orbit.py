...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--radius", type=float, help="radius of the orbit", default=100)
    arg_parser.add_argument("--altitude", type=float, help="altitude of orbit (in positive meters)", default=100)
    arg_parser.add_argument("--speed", type=float, help="speed of orbit (in meters/second)", default=1)
    ...
    arg_parser.add_argument("--iterations", type=float, help="number of 360 degree orbits (default 3)", default=3000)
